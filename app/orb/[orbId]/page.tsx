      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500">
                    Created {formatDistanceToNow(orb.createdAt, { addSuffix: true })}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" onClick={() => router.push(`/orb/${orb.id}/edit`)}>
        ...
        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Original prompt and generated logic</CardDescription>
            </CardHeader>
            <CardContent>
